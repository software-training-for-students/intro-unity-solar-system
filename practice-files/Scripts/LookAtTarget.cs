...
public class LookAtTarget : MonoBehaviour {
    ...
    // We can think about it as happening before the scene starts
	void Start () {
        // For our code, this is just for error handling
    ...
    // Whatever is written here, happens constantly while the game is running
    void Update() {
